...
@Ignore("[FABRIC-1111] ExtendedEnsembleTest intermittently fails with immutable version/profile")
    ...
    public void testAddAndRemoveWithVersions() throws Exception {
        ...
        try {
            ...
            try {
                ...
                System.out.println(executeCommand("fabric:container-upgrade --all 1.2"));
                ...
                for (int e = 0; e < 3 && containerQueue.size() >= 2 && containerQueue.size() % 2 == 0; e++) {
                    ...
                    System.out.println(executeCommand("config:proplist --pid io.fabric8.zookeeper"));

                    System.out.println(tryCommand("fabric:container-list"));
                    System.out.println(tryCommand("fabric:ensemble-list"));
                ...
                System.out.println(executeCommand("fabric:version-create"));
                System.out.println(executeCommand("fabric:container-upgrade --all 1.3"));
            ...
            try {
                ...
                for (int version = 3; version < 5; version++) {
                    ...
                    for (int e = 0; e < 3 && containerQueue.size() >= 2 && containerQueue.size() % 2 == 0; e++) {
                        ...
                        System.out.println(executeCommand("fabric:ensemble-list"));
                        ZooKeeperClusterService zooKeeperClusterService = ServiceLocator.awaitService(bundleContext, ZooKeeperClusterService.class);
                        org.junit.Assert.assertNotNull(zooKeeperClusterService);
                        List<String> ensembleContainersResult = zooKeeperClusterService.getEnsembleContainers();
                        org.junit.Assert.assertTrue(ensembleContainersResult.contains(cnt1.getId()));
                    ...
                    System.out.println(executeCommand("fabric:version-create 1." + version));
                    System.out.println(executeCommand("fabric:container-upgrade 1." + version + " " + randomContainer));
                    ...
                    System.out.println(executeCommand("fabric:container-rollback 1." + (version - 1) + " " + randomContainer));
