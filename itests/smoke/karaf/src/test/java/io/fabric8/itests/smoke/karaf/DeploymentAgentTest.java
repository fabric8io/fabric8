...
public class DeploymentAgentTest {
    ...
    public void testFeatureRepoResolution() throws Exception {
        ...
        try {
            ...
            Set<Container> containers = ContainerBuilder.create().withName("smoke_cntA").withProfiles("test-profile").assertProvisioningResult().build(fabricService);
            try {
    ...
    public void testResolveOptionalImports() throws Exception {
        ...
        try {
            FabricService fabricService = fabricProxy.getService();
            Set<Container> containers = ContainerBuilder.create().withName("smoke_cntB").withProfiles("test-profile").assertProvisioningResult().build(fabricService);
            try {
