...
/**
 */
@Command(name = "stop", scope = "process", description = "Stops a managed process")
public class StopAction extends ProcessControlCommandSupport {

    protected StopAction(ProcessManager processManager) {
