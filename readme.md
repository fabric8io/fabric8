...
You can try a [download of the Fuse Fabric code](https://repo.fusesource.com/nexus/content/groups/ea/org/fusesource/fabric/fuse-fabric/) or build the project with maven via:
