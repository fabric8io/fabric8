...
@Component(name = "org.fusesource.mq.fabric.cf", description = "Fabric8 ActiveMQ Connection Factory Service", immediate = true, configurationFactory = true, metatype = true)
