...
public class WildFlyContainerConfigurationBuilder extends ContainerConfigurationBuilder {
    ...
    private final WildFlyContainerConfiguration configuration = new WildFlyContainerConfiguration();

    @Override
    protected WildFlyContainerConfiguration internalConfiguration() {
