...
First you need to get the latest [Jube](jube.html) by [downloading jube-2.0.1-image.zip](http://central.maven.org/maven2/io/fabric8/jube/images/jube/jube/2.0.1/jube-2.0.1-image.zip) and unzipping it:

    curl -O http://central.maven.org/maven2/io/fabric8/jube/images/jube/jube/2.0.1/jube-2.0.1-image.zip
    mkdir jube-2.0.1-image
    cd jube-2.0.1-image
    unzip ../jube-2.0.1-image.zip
...
The following environment variables are used by various [Tools](http://fabric8.io/v2/tools.html) such as the [Web Console](console.html), [Maven Plugin](http://fabric8.io/v2/mavenPlugin.html), the [Forge Addons](http://fabric8.io/v2/forge.html) and the [java libraries](javaLibraries.html):
...
Once Jube has started up you should be able to open the [Web Console](console.html) at [http://localhost:8585/hawtio/](http://localhost:8585/hawtio/) to view the kubernetes system. You can then view these tabs:
