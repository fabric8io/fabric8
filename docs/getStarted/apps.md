...
[packaged](http://repo1.maven.org/maven2/io/fabric8/devops/distro/distro/2.2.89/distro-2.2.89-templates.zip) to make them easy
...
* You can download the [fabric8 templates 2.2.89 distribution](http://repo1.maven.org/maven2/io/fabric8/devops/distro/distro/2.2.89/distro-2.2.89-templates.zip)
...
Download and unzip the [fabric8 templates 2.2.89 distribution](http://repo1.maven.org/maven2/io/fabric8/devops/distro/distro/2.2.89/distro-2.2.89-templates.zip).
