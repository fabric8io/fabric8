...
e.g. to upload a single profile as a zip
    ...
    profile-import mvn:io.fabric8.quickstarts.fabric/camel-cdi/1.2.0.Beta1/zip/profile

or to upload all of the quickstarts:

    profile-import mvn:io.fabric8.quickstarts.fabric/fabric8-quickstarts-parent/1.2.0.Beta1/zip/profile

You can specify a specific version to use:

    profile-import -v 1.1 mvn:io.fabric8.quickstarts.fabric/camel-cdi/1.2.0.Beta1/zip/profile
...
and then import to new version with
    ...
    profile-import -v 1.2 mvn:io.fabric8.quickstarts.fabric/camel-cdi/1.2.0.Beta1/zip/profile
