...
public class ContextResumeCommand extends AbstractJolokiaCommand {
    ...
    public UICommandMetadata getMetadata(UIContext context) {
        return Metadata.forCommand(ConnectCommand.class).name(
                "camel-context-resume").category(Categories.create(CATEGORY))
                .description("Resume a Camel context");
    }
