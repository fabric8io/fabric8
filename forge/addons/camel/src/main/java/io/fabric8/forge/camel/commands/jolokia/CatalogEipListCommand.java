...
public class CatalogEipListCommand extends AbstractJolokiaCommand {

    @Inject
    @WithAttributes(label = "label", required = false, description = "To filter EIPs by their label(s), such as transformation")
    ...
    public Result execute(UIExecutionContext context) throws Exception {
        ...
        org.apache.camel.commands.CatalogEipListCommand command = new org.apache.camel.commands.CatalogEipListCommand(val, label.getValue());
