...
public class CatalogDataFormatLabelListCommand extends AbstractJolokiaCommand {
    ...
    public UICommandMetadata getMetadata(UIContext context) {
        return Metadata.forCommand(ConnectCommand.class).name(
                "camel-catalog-dataformat-label-list").category(Categories.create(CATEGORY_CATALOG))
                .description("Lists all Camel dataformat labels from the Camel catalog");
    }
    ...
    public Result execute(UIExecutionContext context) throws Exception {
        ...
        org.apache.camel.commands.CatalogDataFormatLabelListCommand command = new org.apache.camel.commands.CatalogDataFormatLabelListCommand(val);
