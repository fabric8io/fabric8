...
public class RestShowCommand extends AbstractJolokiaCommand {
    ...
    public UICommandMetadata getMetadata(UIContext context) {
        return Metadata.forCommand(ConnectCommand.class).name(
                "camel-rest-show").category(Categories.create(CATEGORY))
                .description("Display the Camel REST definition in XML");
    }
