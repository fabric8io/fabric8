...
public class RouteShowCommand extends AbstractJolokiaCommand {
    ...
    public UICommandMetadata getMetadata(UIContext context) {
        return Metadata.forCommand(ConnectCommand.class).name(
                "camel-route-show").category(Categories.create(CATEGORY))
    ...
    public Result execute(UIExecutionContext context) throws Exception {
        ...
        org.apache.camel.commands.RouteShowCommand command = new org.apache.camel.commands.RouteShowCommand(route.getValue(), name.getValue());
