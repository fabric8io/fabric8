...
public class RouteProfileCommand extends AbstractJolokiaCommand {
    ...
    public UICommandMetadata getMetadata(UIContext context) {
        return Metadata.forCommand(ConnectCommand.class).name(
                "camel-route-profile").category(Categories.create(CATEGORY))
                .description("Display profile information about Camel routes");
    }
