...
public class CatalogDataFormatListCommand extends AbstractJolokiaCommand {

    @Inject
    @WithAttributes(label = "label", required = false, description = "To filter dataformats by their label(s), such as xml")
    ...
    public Result execute(UIExecutionContext context) throws Exception {
        ...
        org.apache.camel.commands.CatalogDataFormatListCommand command = new org.apache.camel.commands.CatalogDataFormatListCommand(val, label.getValue());
