...
public class RouteSuspendCommand extends AbstractJolokiaCommand {
    ...
    public UICommandMetadata getMetadata(UIContext context) {
        return Metadata.forCommand(ConnectCommand.class).name(
                "camel-route-suspend").category(Categories.create(CATEGORY))
                .description("Suspend a Camel route");
    }
