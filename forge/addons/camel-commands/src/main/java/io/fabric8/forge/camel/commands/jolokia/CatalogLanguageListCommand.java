...
public class CatalogLanguageListCommand extends AbstractJolokiaCommand {

    @Inject
    @WithAttributes(label = "label", required = false, description = "To filter languages by their label(s), such as xml")
    ...
    public UICommandMetadata getMetadata(UIContext context) {
        return Metadata.forCommand(ConnectCommand.class).name(
                "camel-catalog-language-list").category(Categories.create(CATEGORY_CATALOG))
    ...
    public Result execute(UIExecutionContext context) throws Exception {
        ...
        org.apache.camel.commands.CatalogLanguageListCommand command = new org.apache.camel.commands.CatalogLanguageListCommand(val, label.getValue());
