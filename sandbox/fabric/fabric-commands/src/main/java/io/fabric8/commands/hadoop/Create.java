...
public class Create extends AbstractCommandComponent {
    ...
    private ContainerCompleter nameNodeContainerCompleter; // dummy field
    ...
    private ContainerCompleter dataNodeContainerCompleter; // dummy field
    ...
    public Action createNewAction() {
        assertValid();
        return new CreateAction(fabricService.get());
    }
    ...
    void bindNameNodeContainerCompleter(ContainerCompleter completer) {
        bindOptionalCompleter("--name-node", completer);
    }
    ...
    void bindDataNodeContainerCompleter(ContainerCompleter completer) {
        bindOptionalCompleter("--data-nodes", completer);
    }
