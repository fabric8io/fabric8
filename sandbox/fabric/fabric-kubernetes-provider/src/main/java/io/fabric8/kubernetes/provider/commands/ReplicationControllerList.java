...
@org.apache.felix.scr.annotations.Properties({
        @Property(name = "osgi.command.scope", value = ReplicationControllerList.SCOPE_VALUE),
        @Property(name = "osgi.command.function", value = ReplicationControllerList.FUNCTION_VALUE)
})
public class ReplicationControllerList extends AbstractCommandComponent {

    public static final String SCOPE_VALUE = "fabric";
    public static final String FUNCTION_VALUE = "replicationController-list";
    public static final String DESCRIPTION = "Lists the available services in kubernetes";
    ...
    public Action createNewAction() {
        assertValid();
        return new ReplicationControllerListAction(kubernetesService.get());
    }
