...
@org.apache.felix.scr.annotations.Properties({
        @Property(name = "osgi.command.scope", value = Start.SCOPE_VALUE),
        @Property(name = "osgi.command.function", value = Start.FUNCTION_VALUE)
})
public class Start extends AbstractCommandComponent {

    public static final String SCOPE_VALUE = "process";
    public static final String FUNCTION_VALUE = "start";
    public static final String DESCRIPTION = "Starts a managed process";
    ...
    public Action createNewAction() {
        assertValid();
        return new StartAction(processManager.get());
    }
