...
@org.apache.felix.scr.annotations.Properties({
        @Property(name = "osgi.command.scope", value = Stop.SCOPE_VALUE),
        @Property(name = "osgi.command.function", value = Stop.FUNCTION_VALUE)
})
public class Stop extends AbstractCommandComponent {

    public static final String SCOPE_VALUE = "process";
    public static final String FUNCTION_VALUE = "stop";
    public static final String DESCRIPTION = "Stops a managed process";
    ...
    public Action createNewAction() {
        assertValid();
        return new StopAction(processManager.get());
    }
