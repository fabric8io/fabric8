...
@org.apache.felix.scr.annotations.Properties({
        @Property(name = "osgi.command.scope", value = Restart.SCOPE_VALUE),
        @Property(name = "osgi.command.function", value = Restart.FUNCTION_VALUE)
})
public class Restart extends AbstractCommandComponent {

    public static final String SCOPE_VALUE = "process";
    public static final String FUNCTION_VALUE = "restart";
    public static final String DESCRIPTION = "Restarts a managed process";
    ...
    public Action createNewAction() {
        assertValid();
        return new RestartAction(processManager.get());
    }
