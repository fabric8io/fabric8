 ...
 *
 */
public class BridgeConnectorParser extends AbstractSimpleBeanDefinitionParser {
	...
	private static final String REMOTE_BROKER_CONFIG_PROPERTY = "remoteBrokerConfig";
