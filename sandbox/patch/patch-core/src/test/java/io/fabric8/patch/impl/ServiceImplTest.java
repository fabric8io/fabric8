...
public class ServiceImplTest {
    ...
    private File createBundle(String bundleSymbolicName, String version) throws Exception {
        ...
        ContainerManifest mf = new ContainerManifest();
        mf.getMainAttributes().putValue("ContainerManifest-Version", "1.0");
        mf.getMainAttributes().putValue("Bundle-ContainerManifestVersion", "2");
