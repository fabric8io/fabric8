...
@ThreadSafe
@Component(name = "io.fabric8.partition", description = "Fabric8 Work Manager Factory", configurationFactory = true, policy = ConfigurationPolicy.REQUIRE, metatype = true)
