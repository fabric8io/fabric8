...
To register this service (= Interfaces) into the OSGI registry, we use the following Blueprint syntax
    ...
    <blueprint xmlns="http://www.osgi.org/xmlns/blueprint/v1.0.0">
        ...
        <bean id="myService" class="io.fabric.example.dosgi.impl.ServiceImpl"/>
...
<reference id="myService" interface="io.fabric.example.dosgi.Service" availability="optional"/>
