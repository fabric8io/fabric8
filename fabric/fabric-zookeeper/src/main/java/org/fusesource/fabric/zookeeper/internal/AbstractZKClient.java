...
public abstract class AbstractZKClient extends org.linkedin.zookeeper.client.AbstractZKClient implements IZKClient, Watcher {
     ...
     * Constructor
     */
    public AbstractZKClient(String connectString, Timespan sessionTimeout, Watcher watcher)
    {
     ...
     * Constructor
     */
    public AbstractZKClient(IZooKeeperFactory factory)
    {
        this(factory, null);
    }
     ...
     * Constructor
     */
    public AbstractZKClient(IZooKeeperFactory factory, String chroot)
    {
        super(chroot);
        _factory = factory;
    }
