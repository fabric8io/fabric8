...
public class ConfigUtilsTest {
    ...
    public void testIsConfigurationManaged() throws IOException {
        ...
        assertTrue(ConfigUtils.isConfigurationManaged(configurationAdmin, myPid1));
        assertFalse(ConfigUtils.isConfigurationManaged(configurationAdmin, myPid2));
        assertFalse(ConfigUtils.isConfigurationManaged(configurationAdmin, myPid3));
