...
public final class OpenTypeGenerator {
    ...
    private static Object toArrayData(ArrayType<?> atype, Object value) throws OpenDataException {
        ...
        Object[] array = getTargetArray(elementType, items.size());
    ...
    private static Object[] getTargetArray(OpenType<?> elementType, int dimension) throws OpenDataException {
        Class<?> compType;
        try {
    ...
    private static Object toTargetType(Class<?> targetType, Object value) {
        Object result = value;
        if (value != null && !targetType.isAssignableFrom(value.getClass())) {
            ...
            boolean isAssignable = targetType.isPrimitive() || targetType.isAssignableFrom(result.getClass());
    ...
    private static Object fromArrayData(ArrayType<?> atype, ClassLoader classLoader, Object value) throws OpenDataException {
        ...
        OpenType<?> elementType = atype.getElementOpenType();
        Object[] array = getTargetArray(elementType, elements.length);
