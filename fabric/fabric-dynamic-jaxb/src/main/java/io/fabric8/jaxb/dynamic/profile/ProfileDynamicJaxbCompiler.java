 ...
 */
@Component(name = "io.fabric8.profile.jaxb.compiler", description = "Fabric8 Profile JAXB Compiler", policy = ConfigurationPolicy.OPTIONAL, immediate = true, metatype = true)
