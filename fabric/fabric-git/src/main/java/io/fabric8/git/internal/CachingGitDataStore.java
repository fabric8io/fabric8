...
@References({
        @Reference(referenceInterface = PlaceholderResolverFactory.class, bind = "bindPlaceholderResolverFactory", unbind = "unbindPlaceholderResolverFactory", cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, policy = ReferencePolicy.DYNAMIC),
