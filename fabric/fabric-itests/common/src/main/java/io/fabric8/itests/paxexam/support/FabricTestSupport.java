...
public class FabricTestSupport extends FuseTestSupport {
    ...
    /**
     * Creates a child {@ling Agent} with the given name.
     */
    public Container createChildContainer(String name, String parent, String profileName) throws Exception {
        return createChildContainer(name, parent, profileName, null);
    }

    public Container createChildContainer(String name, String parent, String profileName, String jvmOpts) throws Exception {
    ...
    public void destroyChildContainer(String name) throws InterruptedException {
        try {
    ...
    public void waitForFabricCommands() {
    ...
    public Option[] fabricDistributionConfiguration() {
        return new Option[]{
                ...
                KarafDistributionOption.editConfigurationFilePut("etc/org.apache.felix.fileinstall-deploy.cfg", "felix.fileinstall.active.level", "46"),
                KarafDistributionOption.editConfigurationFilePut("etc/org.apache.felix.fileinstall-deploy.cfg", "felix.fileinstall.log.level", "4"),
                ...
                FuseTestSupport.mavenBundle("io.fabric8.itests", "fabric-itests-common"),
                FuseTestSupport.mavenBundle("org.fusesource.tooling.testing", "pax-exam-karaf"),
                new DoNotModifyLogOption(),
                KarafDistributionOption.keepRuntimeFolder()
        };
    }

    public Option[] managedFabricDistributionConfiguration() {
        return new Option[]{
