...
@org.apache.felix.scr.annotations.Properties({
        @Property(name = "osgi.command.scope", value = PodDelete.SCOPE_VALUE),
        @Property(name = "osgi.command.function", value = PodDelete.FUNCTION_VALUE)
})
public class PodDelete extends AbstractCommandComponent {

    public static final String SCOPE_VALUE = "fabric";
    public static final String FUNCTION_VALUE = "pod-delete";
    public static final String DESCRIPTION = "Delete the given pod(s) in kubernetes";
    ...
    public Action createNewAction() {
        assertValid();
        return new PodDeleteAction(kubernetesService.get());
    }
