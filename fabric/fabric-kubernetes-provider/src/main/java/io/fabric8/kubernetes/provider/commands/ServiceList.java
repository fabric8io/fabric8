...
@org.apache.felix.scr.annotations.Properties({
        @Property(name = "osgi.command.scope", value = ServiceList.SCOPE_VALUE),
        @Property(name = "osgi.command.function", value = ServiceList.FUNCTION_VALUE)
})
public class ServiceList extends AbstractCommandComponent {

    public static final String SCOPE_VALUE = "fabric";
    public static final String FUNCTION_VALUE = "service-list";
    ...
    public Action createNewAction() {
        assertValid();
        return new ServiceListAction(kubernetesService.get());
    }
