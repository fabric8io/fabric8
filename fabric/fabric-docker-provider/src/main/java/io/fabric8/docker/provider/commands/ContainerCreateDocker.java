...
public class ContainerCreateDocker extends AbstractCommandComponent {
    ...
    public static final String DESCRIPTION = "Creates one or more docker containers";
    ...
    public Action createNewAction() {
        assertValid();
        return new ContainerCreateDockerAction(fabricService.get(), clusterService.get());
    }
