...
@Properties({
    @Property(name = "scheme", value = ChecksumPlaceholderResolver.RESOLVER_SCHEME)
})
public final class ChecksumPlaceholderResolver extends AbstractComponent implements PlaceholderResolverFactory {
