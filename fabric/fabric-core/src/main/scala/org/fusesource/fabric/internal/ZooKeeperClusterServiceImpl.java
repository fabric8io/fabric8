    ...
    public void createCluster(List<String> containers) {
        try {
            ...
            for (String container : containers) {
                if (zooKeeper.exists("/fabric/registry/agents/alive/" + container) == null) {
                    throw new FabricException("The agent " + container + " is not alive");
                }
            }
            ...
            for (String container : containers) {
                String ip = zooKeeper.getStringData("/fabric/registry/agents/config/" + container + "/ip");
                ...
                ZooKeeperUtils.add(zooKeeper, "/fabric/configs/versions/" + version + "/agents/" + container, "zk-server-" + newClusterId + "-" + Integer.toString(index));
