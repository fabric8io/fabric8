 ...
 */
public class GitRepoTokenClient extends GitRepoClientSupport {

    private String authorizationType;
    private String authorization;

    public GitRepoTokenClient(String address, String username, String authorizationType, String authorization) {
