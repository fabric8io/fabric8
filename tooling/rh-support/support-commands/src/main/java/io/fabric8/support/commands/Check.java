...
@org.apache.felix.scr.annotations.Properties({
        @Property(name = "osgi.command.scope", value = Check.SCOPE_VALUE),
        @Property(name = "osgi.command.function", value = Check.FUNCTION_VALUE)
})
public class Check extends AbstractCommandComponent {

    public static final String SCOPE_VALUE = "support";
    public static final String FUNCTION_VALUE = "check";
    public static final String DESCRIPTION = "Perform a sanity check ";
    ...
    public Action createNewAction() {
        assertValid();
        return new CheckAction(service.get());
    }
