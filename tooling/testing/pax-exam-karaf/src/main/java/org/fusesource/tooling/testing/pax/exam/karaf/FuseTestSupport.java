...
public class FuseTestSupport {
    ...
    public Bundle installBundle(String groupId, String artifactId) throws Exception {
     ...
     * @return the provisioning option for the given bundle
     */
    public MavenArtifactProvisionOption mavenBundle(String groupId, String artifactId, String version) {
    ...
    * @return
    */
    public String executeCommands(final long timeout, final boolean silent, final String... commands) {
