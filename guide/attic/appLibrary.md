...
If not you can run the App Library on any kubernetes environment as follows:
    ...
    kube apply -f  http://central.maven.org/maven2/io/fabric8/jube/images/fabric8/app-library/2.2.68/app-library-2.2.68-kubernetes.json
...
Download one of the above zips to see the structure used:
      ...
      http://central.maven.org/maven2/io/fabric8//quickstarts/fabric8-quickstarts-parent/2.2.68/fabric8-quickstarts-parent-2.2.68-app.zip