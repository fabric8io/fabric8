...
import org.fusesource.gateway.handlers.detecting.protocol.openwire.support.MarshallingSupport;
import org.fusesource.gateway.handlers.detecting.protocol.openwire.support.OpenwireException;
import org.fusesource.gateway.handlers.detecting.protocol.openwire.support.advisory.AdvisorySupport;
...
public abstract class Message extends BaseCommand implements MarshallAware {
    ...
    public abstract org.fusesource.gateway.handlers.detecting.protocol.openwire.command.Message copy();
    ...
    protected void copy(org.fusesource.gateway.handlers.detecting.protocol.openwire.command.Message copy) {
        super.copy(copy);
    ...
    public org.fusesource.gateway.handlers.detecting.protocol.openwire.command.Message getMessageHardRef() {
        return this;
    }

    public org.fusesource.gateway.handlers.detecting.protocol.openwire.command.Message getMessage() throws IOException {
        return this;
    }
