...
public class BlobTransferPolicy {
    ...
    private org.fusesource.gateway.handlers.detecting.protocol.openwire.support.blob.BlobUploadStrategy uploadStrategy;
    ...
    public org.fusesource.gateway.handlers.detecting.protocol.openwire.support.blob.BlobUploadStrategy getUploadStrategy() {
     ...
     */
    public void setUploadStrategy(org.fusesource.gateway.handlers.detecting.protocol.openwire.support.blob.BlobUploadStrategy uploadStrategy) {
    ...
    protected org.fusesource.gateway.handlers.detecting.protocol.openwire.support.blob.BlobUploadStrategy createUploadStrategy() {
        return new org.fusesource.gateway.handlers.detecting.protocol.openwire.support.blob.DefaultBlobUploadStrategy(this);
    }
}
