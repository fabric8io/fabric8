...
public class MessageAckMarshaller extends BaseCommandMarshaller {
    ...
    public void tightUnmarshal(OpenWireFormat wireFormat, Object o, DataByteArrayInputStream dataIn, BooleanStream bs) throws IOException {
        ...
        info.setConsumerId((org.fusesource.gateway.handlers.detecting.protocol.openwire.command.ConsumerId)tightUnmarsalCachedObject(wireFormat, dataIn, bs));
        info.setAckType(dataIn.readByte());
        info.setFirstMessageId((org.fusesource.gateway.handlers.detecting.protocol.openwire.command.MessageId)tightUnmarsalNestedObject(wireFormat, dataIn, bs));
        info.setLastMessageId((org.fusesource.gateway.handlers.detecting.protocol.openwire.command.MessageId)tightUnmarsalNestedObject(wireFormat, dataIn, bs));
    ...
    public void looseUnmarshal(OpenWireFormat wireFormat, Object o, DataByteArrayInputStream dataIn) throws IOException {
        ...
        info.setConsumerId((org.fusesource.gateway.handlers.detecting.protocol.openwire.command.ConsumerId)looseUnmarsalCachedObject(wireFormat, dataIn));
        info.setAckType(dataIn.readByte());
        info.setFirstMessageId((org.fusesource.gateway.handlers.detecting.protocol.openwire.command.MessageId)looseUnmarsalNestedObject(wireFormat, dataIn));
        info.setLastMessageId((org.fusesource.gateway.handlers.detecting.protocol.openwire.command.MessageId)looseUnmarsalNestedObject(wireFormat, dataIn));
        info.setMessageCount(dataIn.readInt());
