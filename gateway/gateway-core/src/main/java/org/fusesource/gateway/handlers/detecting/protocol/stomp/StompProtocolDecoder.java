...
import static org.fusesource.gateway.handlers.detecting.protocol.BufferSupport.chomp;
import static org.fusesource.gateway.handlers.detecting.protocol.BufferSupport.indexOf;
import static org.fusesource.gateway.handlers.detecting.protocol.BufferSupport.trim;
    ...
    final Action<StompFrame> read_action = new Action<StompFrame>() {
        public StompFrame apply() throws IOException {
            ...
            if (line != null) {
                ...
                if (action.length() > 0) {
                    StompFrame frame = new StompFrame(ascii(action));
