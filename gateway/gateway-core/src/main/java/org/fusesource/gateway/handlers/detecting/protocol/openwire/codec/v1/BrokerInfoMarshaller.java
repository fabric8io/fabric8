...
public class BrokerInfoMarshaller extends BaseCommandMarshaller {
    ...
    public void tightUnmarshal(OpenWireFormat wireFormat, Object o, DataByteArrayInputStream dataIn, BooleanStream bs) throws IOException {
        ...
        info.setBrokerId((org.fusesource.gateway.handlers.detecting.protocol.openwire.command.BrokerId)tightUnmarsalCachedObject(wireFormat, dataIn, bs));
        info.setBrokerURL(tightUnmarshalString(dataIn, bs));

        if (bs.readBoolean()) {
            short size = dataIn.readShort();
            org.fusesource.gateway.handlers.detecting.protocol.openwire.command.BrokerInfo value[] = new org.fusesource.gateway.handlers.detecting.protocol.openwire.command.BrokerInfo[size];
            for( int i=0; i < size; i++ ) {
                value[i] = (org.fusesource.gateway.handlers.detecting.protocol.openwire.command.BrokerInfo) tightUnmarsalNestedObject(wireFormat,dataIn, bs);
            }
    ...
    public void looseUnmarshal(OpenWireFormat wireFormat, Object o, DataByteArrayInputStream dataIn) throws IOException {
        ...
        BrokerInfo info = (BrokerInfo)o;
        info.setBrokerId((org.fusesource.gateway.handlers.detecting.protocol.openwire.command.BrokerId)looseUnmarsalCachedObject(wireFormat, dataIn));
        ...
        if (dataIn.readBoolean()) {
            ...
            org.fusesource.gateway.handlers.detecting.protocol.openwire.command.BrokerInfo value[] = new org.fusesource.gateway.handlers.detecting.protocol.openwire.command.BrokerInfo[size];
            for( int i=0; i < size; i++ ) {
                value[i] = (org.fusesource.gateway.handlers.detecting.protocol.openwire.command.BrokerInfo)looseUnmarsalNestedObject(wireFormat,dataIn);
            }
            info.setPeerBrokerInfos(value);
        }
        else {
