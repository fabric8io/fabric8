 ...
 */
package org.fusesource.gateway.handlers.detecting.protocol.ssl;
...
public class SslSocketWrapper extends SocketWrapper implements ReadStream<SslSocketWrapper>, WriteStream<SslSocketWrapper> {
    ...
    @Override
    public org.fusesource.gateway.handlers.detecting.protocol.ssl.SslSocketWrapper dataHandler(Handler<Buffer> handler) {
    ...
    @Override
    public org.fusesource.gateway.handlers.detecting.protocol.ssl.SslSocketWrapper endHandler(Handler<Void> voidHandler) {
        plainEndHandler = voidHandler;
        return this;
    }

    @Override
    public org.fusesource.gateway.handlers.detecting.protocol.ssl.SslSocketWrapper pause() {
        readPaused ++;
        if( readPaused == 1 ) {
    ...
    @Override
    public org.fusesource.gateway.handlers.detecting.protocol.ssl.SslSocketWrapper resume() {
        readPaused --;
        if( readPaused ==0 ) {
    ...
    @Override
    public org.fusesource.gateway.handlers.detecting.protocol.ssl.SslSocketWrapper exceptionHandler(Handler<Throwable> throwableHandler) {
