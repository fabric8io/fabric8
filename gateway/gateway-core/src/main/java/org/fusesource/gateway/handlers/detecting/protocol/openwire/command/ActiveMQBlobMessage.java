...
import org.fusesource.gateway.handlers.detecting.protocol.openwire.support.blob.BlobUploader;
...
public class ActiveMQBlobMessage extends ActiveMQMessage {
    ...
    public org.fusesource.gateway.handlers.detecting.protocol.openwire.support.blob.BlobUploader getBlobUploader() {
        return blobUploader;
    }

    public void setBlobUploader(org.fusesource.gateway.handlers.detecting.protocol.openwire.support.blob.BlobUploader blobUploader) {
